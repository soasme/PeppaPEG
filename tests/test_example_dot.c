...
void test_id(void) {
    ...
    ASSERT_DOT(P4_DotRuleID, "<table>", P4_Ok, "[{\"slice\":[0,7],\"type\":\"ID\"}]");
    ASSERT_DOT(P4_DotRuleID, "<<table>>", P4_Ok, "[{\"slice\":[0,9],\"type\":\"ID\"}]");
    ASSERT_DOT(P4_DotRuleID, "<<table></table>>", P4_Ok, "[{\"slice\":[0,17],\"type\":\"ID\"}]");
}
