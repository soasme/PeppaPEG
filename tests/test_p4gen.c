...
void test_rule(void) {
    ...
    check_parse(P4_P4GenRule, "a = \"0x\"/[1-9]", "[{\"slice\":[0,14],\"type\":\"rule\",\"children\":[{\"slice\":[0,1],\"type\":\"name\"},{\"slice\":[4,14],\"type\":\"choice\",\"children\":[{\"slice\":[4,8],\"type\":\"literal\"},{\"slice\":[9,14],\"type\":\"range\",\"children\":[{\"slice\":[10,11],\"type\":\"char\"},{\"slice\":[12,13],\"type\":\"char\"}]}]}]}]");
    check_parse(P4_P4GenRule, "@lifted @squashed @spaced @nonterminal @scoped @tight\na = \"1\"", "[{\"slice\":[0,61],\"type\":\"rule\",\"children\":[{\"slice\":[0,53],\"type\":\"decorators\",\"children\":[{\"slice\":[0,7],\"type\":\"decorator\"},{\"slice\":[8,17],\"type\":\"decorator\"},{\"slice\":[18,25],\"type\":\"decorator\"},{\"slice\":[26,38],\"type\":\"decorator\"},{\"slice\":[39,46],\"type\":\"decorator\"},{\"slice\":[47,53],\"type\":\"decorator\"}]},{\"slice\":[54,55],\"type\":\"name\"},{\"slice\":[58,61],\"type\":\"literal\"}]}]");
}
